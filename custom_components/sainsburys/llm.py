"""LLM API exposing Sainsbury's catalogue search and basket tools."""
...
if TYPE_CHECKING:
    ...
    from .coordinator import SainsburysData
...
class SainsburysAPI(llm.API):
    ...
    async def async_get_api_instance(self, llm_context: LLMContext) -> APIInstance:
        ...
        return APIInstance(
            ...
            tools=[
                SearchProductsTool(self.entry),
                GetProductTool(self.entry),
                GetBasketTool(self.entry),
                AddBasketItemTool(self.entry),
                SetBasketItemTool(self.entry),
                RemoveBasketItemTool(self.entry),
                ClearBasketTool(self.entry),
            ],
        )
